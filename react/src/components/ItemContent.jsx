...
function ItemContent() {
  ...
  const { itemList , loading } = useSelector((state) => state.itemList);
  ...
  return (
    <article id="itemContent" className="container">
      ...
      ? <div className="icon-loading flex justify-center items-center">
          <svg className="size-20 fill-slate-300" viewBox="0 0 200 200">
      ...
      : <>
                  ...
                  <div className="flex justify-between items-start gap">
                    ...
                    <section>
                      ...
                      <div className="tooltip select-none" data-tip="ปรับแต่ง">
                        <button className={'btn btn-icon ' + (!contentCustomize && 'btn-mix-alternate')} onClick={handleContentCustomize}>
                          <svg viewBox="0 -960 960 960">
          ...
          : <div className="icon-notfound flex flex-col xs:flex-row justify-center items-center text-center xs:text-left gap-4">
